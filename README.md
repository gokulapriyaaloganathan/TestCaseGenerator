...
Step 5 - Run ADO test generator:
        ...
        UI mode:  py cht.py
Step 6 - In UI mode, use "Upload User Guides Folder" to browse and upload a folder of guide files.
        The generator will include uploaded guide content as additional context while creating test cases.( Please do not upload PHI content in the user guide)